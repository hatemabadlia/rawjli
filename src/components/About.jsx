  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={styles.sectionHeadText}>About Rawjli </h2>
      </motion.div>
...
Whether you’re a startup looking to establish a strong brand identity or an established business aiming to expand your reach, Rojewli offers expert guidance and cutting-edge marketing solutions to help you achieve your goals.
      </motion.p>
